...
var APP_CONFIG = {
  ...
  report: {
    ...
    title: 'AI Products Deployment Health Report',
  ...
  // NEW top-level block — this is what N9's From dropdown reads:
notify: {
  allowedFromAliases: ['windsel.mccray@workday.com', 'jeffrey.ditty@workday.com']
},
