...
function _CoreUI_Js_getJsBundle() {
  ...
  '  if (tbody) tbody.innerHTML = \'<tr><td colspan="8" style="text-align:center;padding:24px;color:var(--color-text-muted);">Loading\u2026</td></tr>\';',
  '',
  ...
  '      if (loadInd) loadInd.classList.add(\'hidden\');',
  '      var winLabel = \'Window: \' + (mgmPglData.startDate || mgmPglData.today || \'\') +',
  ...
  '      if (tbody2) tbody2.innerHTML = \'<tr><td colspan="8" style="text-align:center;padding:24px;color:#c62828;">Error: \' + escapeHtml(String(err)) + \'</td></tr>\';',
  ...
  '',
  '  if (rows.length === 0) {',
  '    tbody.innerHTML = \'<tr><td colspan="8" style="text-align:center;padding:24px;color:var(--color-text-muted);">No upcoming surveys match the current filters.</td></tr>\';',
  '    return;',
  '  }',
  '',
  ...
  '    var titleText;',
  '    if (surveyType === \'MGM\') {',
  '      pillClass += \' survey-pill-mgm-planned\';',
  ...
  '      \'<td>\' + escapeHtml(r.accountName    || \'\') + \'<\/td>\' +',
  '      \'<td class="deployment-cell">\' + escapeHtml(r.deploymentName || \'\') + \'<\/td>\' +',
  '      \'<td style="font-size:12px;color:var(--color-text-muted);">\' + escapeHtml(r.productLabel || \'\') + \'<\/td>\' +',
