...
function debugApiGetReferenceP3() {
  var ref = api_getReference();

  // resolvedTeam coverage on resources
  ...
  // Sample 5 resources for spot-check
  ...
  // Spot-check Aidan Votaw specifically (was misclassified before the fix)
...
function debugSlgVsExternalClassification() {
  var ref = api_getReference();
  var resources = ref.resources || [];
  ...
  // For each SLG resource, compute team via SLG path AND External path
  // and report any divergences.
  var divergences = 0;
