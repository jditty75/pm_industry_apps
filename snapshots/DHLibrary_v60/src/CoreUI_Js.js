...
function _CoreUI_Js_getJsBundle() {
  ...
  '  var el = document.getElementById(\'student-kpi-row\');',
  '  if (!el) return;',
  '  var h = kpis.healthActive;',
  '  el.innerHTML = [',
  '    \'<div class="stat-card">\',',
  '    \'  <div class="stat-title">Total Student</div>\',',
  '    \'  <div class="stat-value">\' + kpis.total + \'</div>\',',
  '    \'  <div class="stat-subtitle">\' + kpis.totalActive + \' Active &middot; \' + kpis.totalComplete + \' Complete</div>\',',
  '    \'</div>\',',
  '    \'<div class="stat-card">\',',
  '    \'  <div class="stat-title">Active Health</div>\',',
  '    \'  <div class="stat-value student-health-kpi">\',',
  '    \'    <span class="health-chip health-red">\' + h.red + \'</span>\',',
  '    \'    <span class="health-chip health-yellow">\' + h.yellow + \'</span>\',',
  '    \'    <span class="health-chip health-green">\' + h.green + \'</span>\',',
  '    (h.blue > 0 ? \'    <span class="health-chip health-blue">\' + h.blue + \'</span>\' : \'\'),',
  '    \'  </div>\',',
  '    \'</div>\'',
  '  ].join(\'\');',
  '}',
