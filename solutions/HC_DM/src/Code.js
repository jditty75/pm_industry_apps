/**
 * Healthcare Deployment Health – Top-level code wired to CoreLib.
 *
 * Responsibilities:
 * - UI menu and "Open Web App" entry.
 * - HC-specific TABLES + BAR_CONFIG configuration.
 ...
 *
 * NOTE:
 * - Requires APP_CONFIG from Config_HC.gs
...
var TABLES = [
  ...
  },
  {
    ...
    heading:     'Red / Yellow Deployments - WD Prime',
    description: 'Listing of all deployments in Red or Yellow Status primed by Workday.'
  },
  {
    sheetName:   'Dashboard',
    title:       'PartnerTotal',
...
function openWebApp() {
  ...
  var html =
    ...
    '<p>The Healthcare Deployment Health Web App will open in a new tab.</p>' +
...
/**
 * Master pipeline (snapshot-based) for Healthcare:
