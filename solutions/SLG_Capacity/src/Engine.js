...
function debugCompareResourceDetailPaths() {
  api_flushCaches();
  ...
  // Path A: call api_getResourceDetail (the bug path)
  ...
  // Path B: call computeResourceDetail directly
  ...
  // Verify they return identical results — if not, there's something between them
