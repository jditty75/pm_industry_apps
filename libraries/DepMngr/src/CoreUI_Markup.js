...
function _CoreUI_Markup_buildDeploymentsTab_(ui) {
  ...
  return [
    ...
    '    📊 Review all deployments. Use filters below to narrow by health, partner, owner, stage, industry, or sub-region.',
    '  </div>',
    ...
    '          <span id="filter-drawer-toggle-text">Advanced Filters</span>',
    '          <span id="filter-drawer-toggle-badge" class="badge hidden">0</span>',
    '        </button>',
    '        <div class="advanced-filter-popover" id="filter-drawer" role="dialog" aria-modal="false" aria-labelledby="advanced-filter-popover-title">',
    '          <div class="advanced-filter-popover-header">',
    '            <div>',
    '              <div class="advanced-filter-popover-title" id="advanced-filter-popover-title">Advanced Filters</div>',
    '              <div class="advanced-filter-popover-subtitle">Refine partner, stage, region, and more</div>',
    '            </div>',
    '            <button type="button" class="advanced-filter-popover-close" onclick="closeAdvancedFilterPopover()" aria-label="Close advanced filters">&times;</button>',
    '          </div>',
    '          <div class="advanced-filter-popover-grid advanced-filter-grid">',
    '            <div class="advanced-filter-field" id="partner-filter-field">',
    '              <label class="advanced-filter-label" for="partner-filter">Partner</label>',
    '              <select id="partner-filter" class="filter-select" onchange="onDeploymentFilterChange()"></select>',
    '            </div>',
    '            <div class="advanced-filter-field" id="stage-filter-field">',
    '              <label class="advanced-filter-label" for="stage-filter">Stage</label>',
    '              <select id="stage-filter" class="filter-select" onchange="onDeploymentFilterChange()"></select>',
    '            </div>',
    '            <div class="advanced-filter-field hidden" id="industry-filter-field">',
    ...
    '              <label class="advanced-filter-label" for="ps-subregion-filter">PS Sub Region</label>',
    '              <select id="ps-subregion-filter" class="filter-select" onchange="onDeploymentFilterChange()"></select>',
    '            </div>',
    '            <div class="advanced-filter-popover-section advanced-filter-section hidden" id="product-filter-section">Product details</div>',
    '            <div class="advanced-filter-field hidden" id="product-area-filter-field">',
    '              <label class="advanced-filter-label" for="product-area-filter">Product Area</label>',
    '              <select id="product-area-filter" class="filter-select" onchange="onDeploymentFilterChange()"></select>',
    '            </div>',
    '            <div class="advanced-filter-field hidden" id="function-filter-field">',
    '              <label class="advanced-filter-label" for="function-filter">Function</label>',
    '              <select id="function-filter" class="filter-select" onchange="onDeploymentFilterChange()"></select>',
    '            </div>',
    '          </div>',
    '          <div class="advanced-filter-popover-actions">',
    '            <button type="button" class="btn btn-secondary" onclick="resetAdvancedDeploymentFilters()">Reset advanced</button>',
    '            <button type="button" class="btn btn-primary" onclick="closeAdvancedFilterPopover()">Done</button>',
    '          </div>',
    '        </div>',
    '      </div>',
    '      <button class="btn btn-secondary" type="button" onclick="clearAllDeploymentFilters()">Clear filters</button>',
    '    </div>',
    '    <div class="deployments-active-filters" id="deployments-active-filters"></div>',
    '  </div>',
    ...
    '    </div>',
    '  </div>',
    '  <div id="deployments-filter-backdrop" class="deployments-filter-backdrop" aria-hidden="true"></div>',
    '</div>'
  ].join('\n');
}
