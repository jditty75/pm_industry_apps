...
function _CoreUI_Js_getJsBundle() {
  ...
  '  var wrapper = document.getElementById(\'student-table-wrapper\');',
  ...
  '    var labels = { red: "Red", yellow: "Yellow", green: "Green", blue: "Blue" };',
  ...
  '  var healthClass = \'health-\' + (row.health || \'unknown\').toLowerCase();',
  ...
  '    \'  <td>\' + chevron + \'</td>\',',
  '    \'  <td><span class="health-chip \' + healthClass + \'">\' + escapeHtml(row.health || \'—\') + \'</span></td>\',',
  '    \'  <td>\' + escapeHtml(row.accountName) + \'</td>\',',
