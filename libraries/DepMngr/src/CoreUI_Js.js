...
function _CoreUI_Js_getJsBundle() {
  ...
  '    var trigger       = row[\'Notability Trigger\']             || \'\';',
  '    var valStatus     = row[\'Data Validation Status\']         || \'\';',
  ...
  '',
  '  var dl = document.getElementById(\'notable-trigger-suggestions\');',
  '  if (dl) {',
  '    var seenTriggers = {};',
  '    notableData.forEach(function(r) {',
  '      var t = r[\'Notability Trigger\'];',
  '      if (t) seenTriggers[t] = true;',
  '    });',
  '    dl.innerHTML = Object.keys(seenTriggers).map(function(t) {',
  '      return \'<option value="\' + escapeAttr(t) + \'"><\/option>\';',
  '    }).join(\'\');',
  '  }',
  '',
